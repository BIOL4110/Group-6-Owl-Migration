...
```
# This next chunk is now use to dowload all the data from the Berkeley file we will be using for analysis
```{r}
...
# In this next chunk we will specify be extracting all the temperature data for the grid
...
# This chunk needs to be rerun 12 times changing the latitude/longitude and ID everytime before the next chunk is to be ran
```{r}
